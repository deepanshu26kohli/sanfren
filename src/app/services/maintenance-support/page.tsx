...
export default function MaintenanceSupportPage() {
    ...
    return (
        <div className="flex flex-col">
            ...
            <ServiceDetail
                title="Reliable Support for Ongoing Success"
                description="Our maintenance services ensure your critical applications run smoothly and securely. We provide proactive monitoring, rapid incident response, and continuous optimization to minimize downtime and maximize performance."
